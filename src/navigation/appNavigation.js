            ...
            return (
                <NavigationContainer>
                    <Stack.Navigator initialRouteName='SignUp'>
                        ...
                        <Stack.Screen name="Question1" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question1Screen} />
                        <Stack.Screen name="Question2" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question2Screen} />
                        <Stack.Screen name="Question3" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question3Screen} />
                        <Stack.Screen name="Question4" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question4Screen} />
                        <Stack.Screen name="Question5" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question5Screen} />
                        <Stack.Screen name="Question6" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question6Screen} />
                        <Stack.Screen name="Question7" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question7Screen} />
                        <Stack.Screen name="Question8" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question8Screen} />
                        <Stack.Screen name="Question9" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question9Screen} />
                        <Stack.Screen name="Question10" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question10Screen} />
                        <Stack.Screen name="Question11" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question11Screen} />
                        <Stack.Screen name="Question12" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={Question12Screen} />
                        <Stack.Screen name="ResultatFormation" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={ResultatFormation} />
                        <Stack.Screen name="ResultatProduits" options={{ headerShown: false, gestureEnabled: false, navigationBarHidden: true }} component={ResultatProduits} />
                    </Stack.Navigator>
                </NavigationContainer>
            )
        }
