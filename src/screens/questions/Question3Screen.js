    ...
    return (
        <SafeAreaView className='flex-1'>
            <View className='flex-1 justify-top items-center m-6'>
                <View className='py-6'>
                    <Text className='font-bold text-4xl leading-10 text-gray-700 text-center py-4'>Question 3/12</Text>
                </View>
                <View className='flex justify-center mx-1'>
                    <Text className='text-xl text-gray-500'>Savez-vous comment compresser et décompresser des fichiers sur votre ordinateur ? </Text>
                </View>
            </View>
