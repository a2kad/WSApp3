    ...
    return (
        <SafeAreaView className='flex-1 justify-around'>
            <View className='flex justify-top items-center m-6'>
                <View className='py-6'>
                    <Text className='font-bold text-4xl leading-10 text-gray-700 text-center py-4'>Question 12/12</Text>
                </View>
                <View className='flex justify-center mx-1'>
                    <Text className='text-xl text-gray-500 mb-5'>Quels sont les navigateurs web les plus connus? (5 réponses) </Text>
                    ...
                    <View className='flex-row'>
                        ...
                        />
                        <Text className='text-justify text-xl text-gray-500 my-1.5'>Google Chrome</Text>
                    </View>
                    ...
                    <View className='flex-row'>
                        ...
                        />
                        <Text className='text-justify text-xl text-gray-500 my-1.5'>Firefox</Text>
                    </View>
                    ...
                    <View className='flex-row'>
                        ...
                        />
                        <Text className='text-justify text-xl text-gray-500 my-1.5'>Opera</Text>
                    </View>
                    ...
                    <View className='flex-row'>
                        ...
                        />
                        <Text className='text-justify text-xl text-gray-500 my-1.5'>Safari</Text>
                    </View>
                    ...
                    <View className='flex-row'>
                        ...
                        />
                        <Text className='text-justify text-xl text-gray-500 my-1.5'>Microsoft Edge</Text>
                    </View>
                    ...
                    <View className='flex-row'>
                        ...
                        />
                        <Text className='text-justify text-xl text-gray-500 my-1.5'>SeaMonkey</Text>
                    </View>
                    ...
                    <View className='flex-row'>
                        ...
                        />
                        <Text className='text-justify text-xl text-gray-500 my-1.5'>Sidekick</Text>
                    </View>
